...
document.addEventListener("DOMContentLoaded", () => {
    ...
    form.addEventListener("submit", async (event) => {
        ...
        // Construir la URL
        const scriptURL = `https://script.google.com/macros/s/AKfycbyC4woxbJSeSZnip08wLvlk3wPWPhVVZftCbDdfI7h1hI4Kv7ao33O0X1KYlDN1OApn/exec?action=create_product&producto=${encodeURIComponent(serializedData)}`;
