            ...
            if (data.success) {
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex justify-center gap-2">
                                    ...
                                    <button class="!px-2.5 py-1.5 rounded-md shadow-md !bg-gray-900 !text-white" onclick=" import('/js/proformas/facturacion/read_proforma.js').then(module => module.Read_Detalle_Proforma('${row.cod_proforma}'))" title="Ver Proforma ${row.cod_proforma} ">
                ...
                if (rutas.includes(window.location.pathname)) {
                    ...
                    $(".dataTables_filter").append(`
                        <button class="bg-gray-900 text-white !px-3 !py-2.5 h-fit !text-xs rounded-md hover:-translate-y-1 transition-all duration-300" id="invoke"  onclick=" import('/js/Modal/Modal.js').then(module => module.Open_Modal('modal_product'))">
