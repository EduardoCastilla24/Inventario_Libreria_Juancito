...
export async function Read_Detalle_Proforma(cod_prod) {
    ...
    const response = await fetch(
        `https://script.google.com/macros/s/AKfycbyC4woxbJSeSZnip08wLvlk3wPWPhVVZftCbDdfI7h1hI4Kv7ao33O0X1KYlDN1OApn/exec?action=search_proforma&cod_proforma=${cod_prod}`
    );
